...
class RequestUtilsTest {
    ...
    fun testAddQuery() {
        assertEquals(
            "https://github.com/tangcent/easy-api/pulls",
            RequestUtils.addQuery("https://github.com/tangcent/easy-api/pulls", null)
        )
        assertEquals(
            "https://github.com/tangcent/easy-api/pulls?q=is%3Apr+label%3Aenhancement+",
            RequestUtils.addQuery("https://github.com/tangcent/easy-api/pulls", "q=is%3Apr+label%3Aenhancement+")
        )
        assertEquals(
            "https://github.com/tangcent/easy-api/pulls?q=is%3Apr+label%3Aenhancement+",
            RequestUtils.addQuery("https://github.com/tangcent/easy-api/pulls", "?q=is%3Apr+label%3Aenhancement+")
    ...
    fun testAddProtocolIfNeed() {
        assertEquals(
            "https://github.com/tangcent/easy-api/pulls",
            RequestUtils.addProtocolIfNeed("https://github.com/tangcent/easy-api/pulls", "https:")
        )
        assertEquals(
            "https://github.com/tangcent/easy-api/pulls",
            RequestUtils.addProtocolIfNeed("github.com/tangcent/easy-api/pulls", "https")
        )
        assertEquals(
            "https://github.com/tangcent/easy-api/pulls",
            RequestUtils.addProtocolIfNeed("https://github.com/tangcent/easy-api/pulls", "ftp:")
        )
    }
    ...
    fun testUrlBuild() {
        ...
        build.path("tangcent/easy-api/pulls")
        assertEquals("https://github.com/tangcent/easy-api/pulls", build.url())
        build.query("token=123")
        assertEquals("https://github.com/tangcent/easy-api/pulls?token=123", build.url())
        build.query("q", "is%3Apr+label%3Aenhancement+")
        assertEquals(
            "https://github.com/tangcent/easy-api/pulls?token=123&q=is%3Apr+label%3Aenhancement+",
            build.url()
        )
    }
}
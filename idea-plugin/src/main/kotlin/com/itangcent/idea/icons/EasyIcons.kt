...
object EasyIcons : Log() {
    ...
    val Close by lazy {
        tryLoad(
            ...
            "/actions/close.svg",
            "/assets/close.svg"
        ) ?: tryLoadByUrl(URL("https://raw.githubusercontent.com/tangcent/easy-api/master/assets/close.png"))
    }
    ...
    val OK by lazy {
        tryLoad(
            ...
            "/assets/ok.svg",
        ) ?: tryLoadByUrl(URL("https://raw.githubusercontent.com/tangcent/easy-api/master/assets/ok.png"))
    }

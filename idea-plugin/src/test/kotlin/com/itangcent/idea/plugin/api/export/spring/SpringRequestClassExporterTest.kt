...
internal class SpringRequestClassExporterTest : PluginContextLightCodeInsightFixtureTestCase() {
    ...
    fun testExportFromTestCtrlWithExpanded() {
        ...
        requests[12].let { request ->
            ...
            assertEquals(
                "[{\"name\":\"id\",\"desc\":\"primary key\",\"required\":false,\"type\":\"text\"},{\"name\":\"code\",\"desc\":\"node code\",\"required\":false,\"type\":\"text\"},{\"name\":\"parent.id\",\"desc\":\"primary key\",\"required\":false,\"type\":\"text\"},{\"name\":\"parent.code\",\"desc\":\"node code\",\"required\":false,\"type\":\"text\"},{\"name\":\"parent.parent.key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"parent.sub[0].key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"parent.siblings[0].key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"sub[0].id\",\"desc\":\"primary key\",\"required\":false,\"type\":\"text\"},{\"name\":\"sub[0].code\",\"desc\":\"node code\",\"required\":false,\"type\":\"text\"},{\"name\":\"sub[0].parent.key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"sub[0].sub[0].key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"sub[0].siblings[0].key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"siblings[0].id\",\"desc\":\"primary key\",\"required\":false,\"type\":\"text\"},{\"name\":\"siblings[0].code\",\"desc\":\"node code\",\"required\":false,\"type\":\"text\"},{\"name\":\"siblings[0].parent.key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"siblings[0].sub[0].key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"siblings[0].siblings[0].key\",\"desc\":\"\",\"required\":false,\"type\":\"text\"}]",
                request.formParams.toJson()
            )
            assertEquals(
                    "{\"code\":0,\"@required\":{\"code\":false,\"msg\":false,\"data\":false},\"@comment\":{\"code\":\"response code\",\"msg\":\"message\",\"data\":\"response data\"},\"msg\":\"\",\"data\":{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{},\"sub\":[{}],\"siblings\":[{}]},\"sub\":[{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{},\"sub\":[{}],\"siblings\":[{}]}],\"siblings\":[{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{},\"sub\":[{}],\"siblings\":[{}]}]}}",
                    request.response!![0].body.toJson()
            )
        }
        requests[13].let { request ->
            ...
            assertEquals("GET", request.method)
            assertEquals(
                "[{\"name\":\"id\",\"value\":\"\",\"desc\":\"primary key\",\"required\":false},{\"name\":\"children[0].id\",\"value\":\"\",\"desc\":\"primary key\",\"required\":false},{\"name\":\"children[0].code\",\"value\":\"\",\"desc\":\"node code\",\"required\":false},{\"name\":\"children[0].parent.key\",\"desc\":\"\",\"required\":false},{\"name\":\"children[0].sub[0].key\",\"desc\":\"\",\"required\":false},{\"name\":\"children[0].siblings[0].key\",\"desc\":\"\",\"required\":false}]",
                request.querys.toJson()
            )
            assertEquals(
                    "{\"code\":0,\"@required\":{\"code\":false,\"msg\":false,\"data\":false},\"@comment\":{\"code\":\"response code\",\"msg\":\"message\",\"data\":\"response data\"},\"msg\":\"\",\"data\":{\"id\":\"\",\"@required\":{\"id\":false,\"children\":false},\"@comment\":{\"id\":\"primary key\",\"children\":\"sub nodes\"},\"children\":[{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{},\"sub\":[{}],\"siblings\":[{}]}]}}",
                    request.response!![0].body.toJson()
            )
        }
        ...
        requests[16].let { request ->
            ...
            assertEquals("POST", request.method)
            assertEquals(
                "[{\"name\":\"size\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"user.id\",\"desc\":\"user id\",\"required\":false,\"type\":\"text\"},{\"name\":\"user.type\",\"desc\":\"user type\\n1 :administration\\n2 :a person, an animal or a plant\\n3 :Anonymous visitor\",\"required\":false,\"type\":\"text\"},{\"name\":\"user.name\",\"desc\":\"user name\",\"required\":false,\"type\":\"text\"},{\"name\":\"user.age\",\"desc\":\"user age\",\"required\":false,\"type\":\"text\"},{\"name\":\"user.sex\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"user.birthDay\",\"desc\":\"user birthDay\",\"required\":false,\"type\":\"text\"},{\"name\":\"user.regtime\",\"desc\":\"user regtime\",\"required\":false,\"type\":\"text\"},{\"name\":\"users[0].id\",\"desc\":\"user id\",\"required\":false,\"type\":\"text\"},{\"name\":\"users[0].type\",\"desc\":\"user type\\n1 :administration\\n2 :a person, an animal or a plant\\n3 :Anonymous visitor\",\"required\":false,\"type\":\"text\"},{\"name\":\"users[0].name\",\"desc\":\"user name\",\"required\":false,\"type\":\"text\"},{\"name\":\"users[0].age\",\"desc\":\"user age\",\"required\":false,\"type\":\"text\"},{\"name\":\"users[0].sex\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"users[0].birthDay\",\"desc\":\"user birthDay\",\"required\":false,\"type\":\"text\"},{\"name\":\"users[0].regtime\",\"desc\":\"user regtime\",\"required\":false,\"type\":\"text\"},{\"name\":\"t.id\",\"desc\":\"user id\",\"required\":false,\"type\":\"text\"},{\"name\":\"t.type\",\"desc\":\"user type\\n1 :administration\\n2 :a person, an animal or a plant\\n3 :Anonymous visitor\",\"required\":false,\"type\":\"text\"},{\"name\":\"t.name\",\"desc\":\"user name\",\"required\":false,\"type\":\"text\"},{\"name\":\"t.age\",\"desc\":\"user age\",\"required\":false,\"type\":\"text\"},{\"name\":\"t.sex\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"t.birthDay\",\"desc\":\"user birthDay\",\"required\":false,\"type\":\"text\"},{\"name\":\"t.regtime\",\"desc\":\"user regtime\",\"required\":false,\"type\":\"text\"}]",
                request.formParams.toJson()
            )
            assertEquals(
                    "{\"code\":0,\"@required\":{\"code\":false,\"msg\":false,\"data\":false},\"@comment\":{\"code\":\"response code\",\"msg\":\"message\",\"data\":\"response data\"},\"msg\":\"\",\"data\":{\"\":\"\"}}",
    ...
    fun testExportFromTestCtrlWithOutExpanded() {
        ...
        requests[12].let { request ->
            ...
            assertEquals("POST", request.method)
            assertEquals(
                "[{\"name\":\"id\",\"desc\":\"primary key\",\"required\":false,\"type\":\"text\"},{\"name\":\"code\",\"desc\":\"node code\",\"required\":false,\"type\":\"text\"},{\"name\":\"parent\",\"value\":\"{\\n  \\\"id\\\": \\\"\\\",\\n  \\\"code\\\": \\\"\\\",\\n  \\\"parent\\\": {},\\n  \\\"sub\\\": [\\n    {}\\n  ],\\n  \\\"siblings\\\": [\\n    {}\\n  ]\\n}\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"sub\",\"value\":\"{\\n  \\\"id\\\": \\\"\\\",\\n  \\\"code\\\": \\\"\\\",\\n  \\\"parent\\\": {},\\n  \\\"sub\\\": [\\n    {}\\n  ],\\n  \\\"siblings\\\": [\\n    {}\\n  ]\\n}\",\"desc\":\"sub nodes\",\"required\":false,\"type\":\"text\"},{\"name\":\"siblings\",\"value\":\"{\\n  \\\"id\\\": \\\"\\\",\\n  \\\"code\\\": \\\"\\\",\\n  \\\"parent\\\": {},\\n  \\\"sub\\\": [\\n    {}\\n  ],\\n  \\\"siblings\\\": [\\n    {}\\n  ]\\n}\",\"desc\":\"siblings nodes\",\"required\":false,\"type\":\"text\"}]",
                request.formParams.toJson()
            )
            assertEquals(
                    "{\"code\":0,\"@required\":{\"code\":false,\"msg\":false,\"data\":false},\"@comment\":{\"code\":\"response code\",\"msg\":\"message\",\"data\":\"response data\"},\"msg\":\"\",\"data\":{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{},\"sub\":[{}],\"siblings\":[{}]},\"sub\":[{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{},\"sub\":[{}],\"siblings\":[{}]}],\"siblings\":[{\"id\":\"\",\"@required\":{\"id\":false,\"code\":false,\"parent\":false,\"sub\":false,\"siblings\":false},\"@comment\":{\"id\":\"primary key\",\"code\":\"node code\",\"parent\":\"\",\"sub\":\"sub nodes\",\"siblings\":\"siblings nodes\"},\"code\":\"\",\"parent\":{},\"sub\":[{}],\"siblings\":[{}]}]}}",
        ...
        requests[16].let { request ->
            ...
            assertEquals("POST", request.method)
            assertEquals(
                "[{\"name\":\"size\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"user\",\"value\":\"{\\n  \\\"id\\\": 0,\\n  \\\"type\\\": 0,\\n  \\\"name\\\": \\\"\\\",\\n  \\\"age\\\": 0,\\n  \\\"sex\\\": 0,\\n  \\\"birthDay\\\": \\\"\\\",\\n  \\\"regtime\\\": \\\"\\\"\\n}\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"users\",\"value\":\"{\\n  \\\"id\\\": 0,\\n  \\\"type\\\": 0,\\n  \\\"name\\\": \\\"\\\",\\n  \\\"age\\\": 0,\\n  \\\"sex\\\": 0,\\n  \\\"birthDay\\\": \\\"\\\",\\n  \\\"regtime\\\": \\\"\\\"\\n}\",\"desc\":\"\",\"required\":false,\"type\":\"text\"},{\"name\":\"t\",\"value\":\"{\\n  \\\"id\\\": 0,\\n  \\\"type\\\": 0,\\n  \\\"name\\\": \\\"\\\",\\n  \\\"age\\\": 0,\\n  \\\"sex\\\": 0,\\n  \\\"birthDay\\\": \\\"\\\",\\n  \\\"regtime\\\": \\\"\\\"\\n}\",\"desc\":\"\",\"required\":false,\"type\":\"text\"}]",
                request.formParams.toJson()
            )
            assertEquals(
                    "{\"code\":0,\"@required\":{\"code\":false,\"msg\":false,\"data\":false},\"@comment\":{\"code\":\"response code\",\"msg\":\"message\",\"data\":\"response data\"},\"msg\":\"\",\"data\":{\"\":\"\"}}",

...
internal class HttpSettingsHelperTest : SettingsHelperTest() {
    ...
    fun testCheckTrustUrl() {
        ...
        assertTrue(httpSettingsHelper.checkTrustUrl("https://raw.githubusercontent.com/tangcent/easy-api/master/third/swagger.config"))
        assertFalse(httpSettingsHelper.checkTrustUrl("https://raw.githubusercontent.com/itangcent"))
        assertFalse(httpSettingsHelper.checkTrustUrl("https://raw.githubusercontent.com/itangcent/easy-api/master/third/swagger.config"))

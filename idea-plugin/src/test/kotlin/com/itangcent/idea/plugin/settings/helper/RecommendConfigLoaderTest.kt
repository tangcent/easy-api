...
internal class RecommendConfigLoaderTest {
    ...
    fun testSelectedCodes() {
        assertEquals(
            "[module, ignore, Jackson, Gson, ignore_transient_field, spring.validations, is_file, import_spring_properties, ignore_serialVersionUID, properties, Fastjson]",
    ...
    fun testDefaultCodes() {
        assertEquals(
            "module,ignore,deprecated_java,deprecated_kotlin,Jackson,Gson,ignore_transient_field,converts,spring_Entity,spring.validations,spring.ui,javax.validation,is_file,ignore_serialVersionUID,properties,Fastjson",

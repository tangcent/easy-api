...
internal class RecommendConfigLoaderTest {
    ...
    fun testBuildRecommendConfig() {
        assertEquals(
            ResultLoader.load(),
            RecommendConfigLoader.buildRecommendConfig("-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-import_spring_properties,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),-support_mock_for_javax_validation")
                .toUnixString()
        )
    }
    ...
    fun testAddSelectedConfig() {
        assertEquals(
            "-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),-support_mock_for_javax_validation,import_spring_properties",
            RecommendConfigLoader.addSelectedConfig(
                "-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-import_spring_properties,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),-support_mock_for_javax_validation,import_spring_properties",
                "import_spring_properties"
            )
        )
        assertEquals(
            "-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-import_spring_properties,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),-support_mock_for_javax_validation,import_spring_properties,module",
            RecommendConfigLoader.addSelectedConfig(
                "-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-import_spring_properties,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),-support_mock_for_javax_validation,import_spring_properties",
                "module"
            )
        ...
        assertEquals(
            "-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-import_spring_properties,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),import_spring_properties,support_mock_for_javax_validation",
            RecommendConfigLoader.addSelectedConfig(
                "-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-import_spring_properties,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),-support_mock_for_javax_validation,import_spring_properties",
    ...
    fun testRemoveSelectedConfig() {
        assertEquals(
            "-Jackson_JsonIgnoreProperties,-converts,-spring.ui,-import_spring_properties,-support_mock_for_general,-deprecated_java,-deprecated_kotlin,-spring_Entity,-spring_webflux,-javax.validation,-javax.validation(strict),-support_mock_for_javax_validation",

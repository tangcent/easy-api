...
internal class RecommendConfigLoaderTest {
    ...
    fun testDefaultCodes() {
        assertEquals(
            "module,ignore,deprecated_java,deprecated_kotlin,Jackson,Gson,ignore_transient_field,converts,spring_Entity,spring.validations,spring.ui,jakarta.validation,javax.validation,is_file,ignore_serialVersionUID,properties,Fastjson,enum_auto_select_field_by_type",

...
internal class CachedResourceResolverTest : AdvancedContextTest() {
    ...
    fun testCachedResourceFromGithub() {
        ...
        try {
            val resource =
                resourceResolver.resolve("https://raw.githubusercontent.com/tangcent/easy-api/master/LICENSE")
            ...
            Mockito.verify(httpSettingsHelper, times(1))
                .checkTrustUrl(eq("https://raw.githubusercontent.com/tangcent/easy-api/master/LICENSE"), any())

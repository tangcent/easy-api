...
Some files under `skills/easy-api-assistant/` are generated from code or mirrored
...
(`RuleKeySchemeExporterTest`, `EasyApiAssistantSkillTest`) fail when the committed
copies drift.

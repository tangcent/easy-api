...
import com.itangcent.easyapi.settings.read
 ...
 * the export boundary ([com.itangcent.easyapi.exporter.ExportOrchestrator])
...
class ChannelRegistry(private val project: Project) : IdeaLog {
     ...
     * [com.itangcent.easyapi.settings.DefaultSettingBinder]).
     *

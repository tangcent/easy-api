 ...
 * via the `com.itangcent.idea.plugin.easy-api.apiChannel` extension point.
 *
...
class ApiChannelRegistry(private val project: Project) : IdeaLog {
    ...
    companion object {
        ...
        private val CHANNEL_EP = ExtensionPointName.create<ApiChannel>("com.itangcent.idea.plugin.easy-api.apiChannel")
    }

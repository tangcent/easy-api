...
class EnvironmentSyncDialog(
    ...
    private val mode: EnvironmentSyncSupport.SyncMode,
    ...
    init {
        title = when (mode) {
            EnvironmentSyncSupport.SyncMode.PUSH -> "Push Environments to Postman"
            EnvironmentSyncSupport.SyncMode.PULL -> "Pull Environments from Postman"
        }
        init()
    }
    ...
    override fun createCenterPanel(): JComponent {
        ...
        val optionsPanel = JPanel().apply {
            ...
            if (mode == EnvironmentSyncSupport.SyncMode.PULL) {
    ...
    private fun loadWorkspaces(listPanel: JPanel) {
        ...
        workspaceCombo.addActionListener {
            ...
            if (mode == EnvironmentSyncSupport.SyncMode.PULL && workspaces.isNotEmpty()) {

...
class ScriptApiEndpoint(
    ...
    //
    // The trailing [example] arg (default null) is threaded through to the
    // underlying [ApiEndpoint] so Swagger `@Parameter#example` /
    // `@Header#example` can be carried as a parameter/header example. It is
    // optional for backward script compatibility: existing rule scripts that
    // omit it still compile and resolve to the 4-arg overload generated by
    // [@JvmOverloads] (Groovy's MOP does not see Kotlin's synthetic
    // default-arg bridge, so the generated Java overloads are required).
    //
    ...
    /** Adds a query parameter. @param example optional example value. */
    @JvmOverloads
    ...
    /** Adds a form parameter. @param example optional example value. */
    @JvmOverloads
    ...
    /** Adds a request header. @param example optional example value. */
    @JvmOverloads
    ...
    /** Adds a response header. @param example optional example value. */
    @JvmOverloads

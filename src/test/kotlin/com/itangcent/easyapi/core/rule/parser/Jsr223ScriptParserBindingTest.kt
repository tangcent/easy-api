...
class Jsr223ScriptParserBindingTest {
    ...
    private val parserSourceFile = File("src/main/kotlin/com/itangcent/easyapi/core/rule/parser/Jsr223ScriptParser.kt")
    ...
    fun `Jsr223ScriptParser source binds ScriptHttpClient not raw HttpClient`() {
        ...
        assertTrue(
            ...
            source.contains("import com.itangcent.easyapi.core.http.ScriptHttpClient")
        )
        assertTrue(

...
import com.itangcent.easyapi.core.ai.tools.AskClarificationTool
...
class RuleAuthoringAgentTest : EasyApiLightCodeInsightFixtureTestCase() {
    ...
    fun testMultiTurnSharesTranscript() = runBlocking {
        ...
        assertTrue(requests[1].messages.any {
            it is com.itangcent.easyapi.core.ai.AiMessage.User && it.content == "hello"
        })
        // And the second turn's user "again".
        assertTrue(requests[1].messages.any {
            it is com.itangcent.easyapi.core.ai.AiMessage.User && it.content == "again"
        })
    }

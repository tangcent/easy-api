...
class HoppscotchFormatterPureLogicTest {
    ...
    fun `HoppscotchRuleKeys maps to correct RuleKeys`() {
        assertNotNull(HoppscotchRuleKeys.PREREQUEST)
        assertNotNull(HoppscotchRuleKeys.CLASS_PREREQUEST)
        assertNotNull(HoppscotchRuleKeys.COLLECTION_PREREQUEST)
        assertNotNull(HoppscotchRuleKeys.TEST)
        assertNotNull(HoppscotchRuleKeys.CLASS_TEST)
        assertNotNull(HoppscotchRuleKeys.COLLECTION_TEST)
        assertNotNull(HoppscotchRuleKeys.HOST)
        assertNotNull(HoppscotchRuleKeys.FORMAT_AFTER)
    }

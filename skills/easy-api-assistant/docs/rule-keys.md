...
`src/main/kotlin/com/itangcent/easyapi/rule/RuleKeys.kt` in the easy-api repo.
...
| Key | Type | Mode | Aliases |
|-----|------|------|---------|
| `hopp.prerequest` | string | merge | |
| `hopp.class.prerequest` | string | merge | `class.hopp.prerequest` |
| `hopp.collection.prerequest` | event | — | `collection.hopp.prerequest` |
| `hopp.test` | string | merge | |
| `hopp.class.test` | string | merge | `class.hopp.test` |
| `hopp.collection.test` | event | — | `collection.hopp.test` |
| `hopp.host` | string | replace | |
| `hopp.format.after` | event | throw-in-error | |

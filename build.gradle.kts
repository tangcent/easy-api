...
val syncSkillFacts by tasks.registering(JavaExec::class) {
    group = "documentation"
    description = "Generate tools.md / locales.md / extensions.md into the easy-api-assistant skill from the tool registries, the locale registry, and plugin.xml."
    ...
    inputs.dir(file("skills/easy-api-assistant/scripts"))
...
tasks.register("syncSkill") {
    group = "documentation"
    description = "Refresh the entire easy-api-assistant skill mirror (knowledge base, agent catalog, rule-key schemes, rule contexts, fact sheets)."
    dependsOn(
